...
// 
    ...
    // فريسكا
        ...
        prices: [30,30,30,30,40,45,45,60],
        category: "الفريسكا"
    },
          {
        id: 3,
        ...
        des: " ",
        image: "mee.jpg",
        weights: ["موف اون (مارشميللو صوص فاكهة) ","شوجر مامي (مارشميللو صوص فاكهة تورتا)","دوبامين (موز + كراميل + نوتيلا) ","فانتازيا (وايت شوكلت + صوص فاكهة)","مولوتوف (رولانا - نيو كراميلو - كيندر )","المؤدبة (تورتا + رولانا + صوص فاكهة)","باربي (مارشميللو + رولانا + صوص فاكهة)","شوجر دادي (تورتا + بيمبو + نوتيلا)"],
        prices: [30,40,40,40,40,40,40,40],
        category: "الفريسكا"
    },
          {
        id: 6,
        ...
        des: " ",
        image: "mee.jpg",
        weights: ["موف اون (مارشميللو صوص فاكهة) ","شوجر مامي (مارشميللو صوص فاكهة تورتا)","دوبامين (موز + كراميل + نوتيلا) ","فانتازيا (وايت شوكلت + صوص فاكهة)","مولوتوف (رولانا - نيو كراميلو - كيندر )","بامبينو (بيمبو + صوص الفاكهة)","فيتنس (بيمبو + مارشميلو + صوص فاكهة)","كافيين (الكريمة قهوة) ","مالديف (موز + وايت شوكلت + صوص فاكهة)","المؤدبة (تورتا + رولانا + صوص فاكهة)","باربي (مارشميللو + رولانا + صوص فاكهة)","شوجر دادي (تورتا + بيمبو + نوتيلا)","دبي (كنافة بستاشيو)","5G (كيندر + موز)","13 (ميكس تورتا كيندر كارميل)","هشام طه (تورتا + كيندر)","تراميسو(كريمة قهوة + تورتا)","عمر لو(لوتس + وايت شوكلت )","أڤاتار(كريمة توت + رولانا )"],
        prices: [35,45,45,45,60,35,40,40,40,50 ,50 ,60 ,60,60,60,45,50,45,60 ],
        category: "الفريسكا"
    },
        ...
        prices: [20,25,35,40,45,50,40,60  ],
        category: "الفريسكا"
    },
              {
        id: 8,
...

    {
        ...
        des: "",
        image: "wa.jpg",
        weights: ["نوتيلا","كراميل","وايت شوكلت","لوتس", "نوتيلا مارشميللوو ", "بينا كولادا","كيندر","نايت موود","الشديدة","فور سيزون","بيستاشيو","الملظلظ","المطرشم","دبي",],
        prices: [85,90,90,95, 100, 100, 120, 110, 150, 130, 150, 150,150, 170],
        category: "الوافل"
    },
...

    {
        ...
        image: "wa2.jpg",
        weights: ["نوتيلا","كراميل","وايت شوكلت","لوتس", "نوتيلا مارشميللوو ", "بينا كولادا","كيندر","نايت موود","الشديدة","فور سيزون","بيستاشيو","الملظلظ","المطرشم","دبي",],
        prices: [50,50,60,60, 60, 60, 70, 70, 100, 100, 100, 80, 80,100],
        category: "الوافل"
    },
    {
        id: 11,
    ...
    des: "",
    image: "stick.jpg",
    weights: ["نوتيلا", "كراميل", "وايت شوكلت", "لوتس", "فراولة", "توت", "كيندر", "باشن", "ميكس وايت فراولة", "كيندر نوتيلا", "بيستاشيو"],
    prices: [45, 45, 50, 50, 50, 50, 50, 50, 60, 60, 65],
    category: "الوافل"
},
...

    {
        ...
        image: "ba1.jpg",
  weights: ["6 قطع","10 قطع"," 15 قطع"," 20 قطع"," 25 قطع"],
        prices: [40,60,80,100,110],
        category: "بان كيك"
    },
    {
        id: 14,
  ...
  weights: ["6 قطع","10 قطع"," 15 قطع"," 20 قطع"," 25 قطع"],
    ...
    },
    {
        ...
        prices: [30,40,40,40, 50, 45,60,50,60,60,50],
        category: "المشروبات"
    },
